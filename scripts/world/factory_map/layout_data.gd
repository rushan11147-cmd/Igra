...
static func _floor_01() -> Dictionary:
	...
	return {
		...
		"build_ceiling": true,
		"markers": {
			"PlayerSpawn": Vector3(0, 0.4, 44),
			"Reactor": Vector3(-4, 0.1, -24),
			"Mixer": Vector3(4, 0.1, -22),
			"ConveyorA": Vector3(2, 0.1, -28),
			"ConveyorB": Vector3(6, 0.1, -32),
			"HidingCloset": Vector3(28, 0.1, 0),
			"DocumentLog": Vector3(-20, 0.1, 20),
			"Hall8Key": Vector3(-22, 0.1, 12),
			"Hall8Door": Vector3(-38, 0.1, -22),
			"Patrol1": Vector3(-4, 0.1, -24),
			"Patrol2": Vector3(28, 0.1, -8),
			"Patrol3": Vector3(0, 0.1, -40),
			"Patrol4": Vector3(-22, 0.1, 10),
		},
	}
